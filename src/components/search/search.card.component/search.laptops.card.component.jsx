...
const SearchLaptopsCard = ({ search }) => {
  return database.laptops.map(({ id, name, price, description, image }) => {
    if (name.toLowerCase().includes(search) || description.toLowerCase().includes(search)) {
      return (
...
export default SearchLaptopsCard;
